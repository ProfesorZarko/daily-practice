...
import SubotaUserList from "./SubotaUserList";

export default function SubotaUserForm() {
  // inicijalizacija iz localStorage - koristi funkciju da se radi samo jednom
  ...
  return (
    <div className="userForm">
      ...
      {/* predaj users i funkcije UserList komponenti */}
      <UserList users={users} onClear={clearUsers} onRemove={removeUser} />
    </div>
  );
}
